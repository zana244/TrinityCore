...
public:
    ...
    static bool HandleAnticheatJailCommand(ChatHandler* handler, Optional<PlayerIdentifier> player)
    {
        ...
        {
            handler->GetSession()->GetPlayer()->TeleportTo(0, 3848.758057f, -3466.777832f, 583.704834f, 4.721359f);
        }

        WorldLocation loc = WorldLocation(0, 3848.758057f, -3466.777832f, 583.704834f, 4.721359f);// GM Jail Location
