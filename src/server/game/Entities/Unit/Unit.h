...
// BuildValuesCachePosPointers marks of the position of some data inside of BuildValue cache.
...
class TC_GAME_API Unit : public WorldObject
{
    ...
    public:
        ...
        void CalculateSpellDamageTaken(SpellNonMeleeDamage* damageInfo, int32 damage, SpellInfo const* spellInfo, WeaponAttackType attackType = BASE_ATTACK, bool crit = false, bool blocked = false, Spell* spell = nullptr, uint32 effectMask = 0);
        ...
        void AtTargetAttacked(Unit* target, bool canInitialAggro, bool canTapImmediately);
        ...
        uint32 SpellDamageBonusTaken(Unit* caster, SpellInfo const* spellProto, uint32 pdamage, DamageEffectType damagetype, SpellEffectInfo const& spellEffectInfo, uint32 stack = 1) const;
